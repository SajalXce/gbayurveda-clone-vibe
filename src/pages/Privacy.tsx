      ...
      content: [
        {
          ...
          details:
            "We collect information you provide directly, such as your name, email address, phone number, shipping address, and payment information when you make a purchase or create an account.",
        },
        {
      ...
      content: [
        {
          ...
          details:
            "We use your personal information to process and fulfill your orders, communicate about your purchases, and provide customer support.",
        },
        {
          subtitle: "Marketing Communications",
          details:
            "With your consent, we may send you promotional emails about new products, special offers, and health tips related to Ayurvedic wellness.",
        },
        {
          subtitle: "Website Improvement",
          details:
            "We analyze usage data to improve our website functionality, user experience, and product offerings.",
        },
      ],
    },
    {
      ...
      content: [
        {
          subtitle: "Encryption",
          details:
            "We use industry-standard SSL encryption to protect your personal and payment information during transmission.",
        },
        {
          subtitle: "Secure Storage",
          details:
            "Your data is stored on secure servers with appropriate technical and organizational measures to prevent unauthorized access.",
        },
        {
          ...
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                At BrainForce, we are committed to protecting your privacy and
                ensuring the security of your personal information. This Privacy
                Policy explains how we collect, use, and safeguard your data
                when you visit our website or use our services.
              </p>
              <div className="text-center flex flex-col gap-2 text-sm text-muted-foreground">
                <p>
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-muted-foreground">
                ...
                experience on our website. Here's how we use them:
              </p>
